...
nuscenes_image_path = '/work/nu_wq/'
layout_path_obs = "/work/layout/obs/"
layout_path_lane = "/work/layout/lane"

output_dir = "output_de/ddv2_anp_6view/"

config = dict(
    pretrained_model_path="./checkpoints/stable-diffusion-v1-4",
    output_dir=output_dir,
    # resume_from_checkpoint="./outputs/bev_t_adapter/checkpoint-10000",
    arch_mode="{}view_img".format(channel_num), # custom
    dataset="custom",
    ...
    enable_text=False,
    prompt_mode="global", # global local both
    burn_unet=True
)