...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, lp_mask=None, attention_mask=None):
        hidden_states = self.resnets[0](hidden_states, temb)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            hidden_states = attn(hidden_states, encoder_hidden_states=encoder_hidden_states, lp_mask=lp_mask).sample
...
class CrossAttnDownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, lp_mask=None, attention_mask=None, features_adapter=None):
        output_states = ()
        idx = 1
...
class DownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, features_adapter=None): ## adapter
        output_states = ()
        idx = 1
